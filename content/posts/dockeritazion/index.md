...
{{< img "docker-ps.jpg" "Docker ps command output" >}}

{{< img "docker-images.jpg" "Docker images command output" >}}

{{< img "docker-htop.jpg" "htop command output" >}}

{{< img "docker-zfspool-1.jpg" "Zfs pool status" >}}

{{< img "docker-zfspool-2.jpg" "Zfs pool status continued" >}}

{{< img "docker-zfslist.jpg" "Zfs list command output" >}}
