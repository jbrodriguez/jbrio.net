...
import pendolo from './il-pendolo-di-foucault.jpg';
import swan from './the-black-swan.jpg';
import lotr from './the-lord-of-the-rings.jpg';
import seagull from './johnathan-livingston-seagull.jpg';
import cafe from './la-borra-del-cafe.jpg';
import ciudad from './la-ciudad-y-los-perros.jpg';

import godfather from './the-godfather.jpg';
import shawshank from './the-shawshank-redemption.jpg';
import pulp from './pulp-fiction.jpg';
import cinema from './cinema-paradiso.jpg';
import ugly from './the-good-the-bad-the-ugly.jpg';
import cidade from './cidade-de-deus.jpg';
import odyssey from './2001-space-odyssey.jpg';
...
<table class="prose-td:align-middle">
    ...
    <tr>
        <td>
            <Image src={pendolo} alt="Il pendolo di Foucault" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={swan} alt="The Black Swan" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={lotr} alt="The Lord of the Rings" />
        </td>
        <td>
    ...
    <tr>
    <td>
    <Image src={seagull} alt="Jonathan Livingston Seagull" />
    </td>
    <td>
    ...
    <tr>
    <td>
    <Image src={cafe} alt="La borra del café" />
    </td>
    <td>
    ...
    <tr>
    <td>
    <Image src={ciudad} alt="La ciudad y los perros" />
    </td>
    <td>
...
<table class="prose-td:align-middle">
    ...
    <tr>
        <td>
            <Image src={godfather} alt="The Godfather" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={shawshank} alt="The Shawshank Redemption" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={pulp} alt="Pulp Fiction" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={cinema} alt="Nuovo Cinema Paradiso" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={ugly} alt="Il buono, il brutto, il cattivo" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={cidade} alt="Cidade de Deus" />
        </td>
        <td>
    ...
    <tr>
        <td>
            <Image src={odyssey} alt="2001: A Space Odyssey" />
        </td>
        <td>
